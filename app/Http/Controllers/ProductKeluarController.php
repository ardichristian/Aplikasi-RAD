...
class ProductKeluarController extends Controller
{
    ...
    {
        $products = Product::orderBy('namaproduk','ASC')
            ->get()
            ->pluck('namaproduk','id');

        $customers = Customer::orderBy('namacustomer','ASC')
            ->get()
            ->pluck('namacustomer','id');
    ...
    public function apiProductsOut(){
        ...
        return Datatables::of($product)
            ->addColumn('products_name', function ($product){
                return $product->product->namaproduk;
            })
            ->addColumn('customer_name', function ($product){
                return $product->customer->namacustomer;
            })
