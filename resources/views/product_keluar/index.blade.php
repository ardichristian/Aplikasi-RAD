        ...
        <div class="box-body">
            <table id="invoice" class="table table-striped">
                ...
                @foreach($invoice_data as $i)
                    <tbody>
                        <td>{{ $counter }}</td>
                        <td>{{ $i->product->namaproduk }}</td>
                        <td>{{ $i->customer->namacustomer }}</td>
                        <td>{{ $i->qty }}</td>
                        <td>Rp {{ number_format($i->product->harga * $i->qty) }}</td>
                        <td>{{ $i->tanggal }}</td>
                        <td>
            ...
            columns: [
                {data: 'id', name: 'id', 
                    render: function (data, type, row, meta) {
                        ...
                        // 'meta.settings._iDisplayStart' contains the starting point of the display
